...
$TOKEN      = "1138993695:AAHRz65OLdRBYOqavckSalb3FKCx9443JVM";
$usernamebot = "@TeknikSel_bot"; // sesuaikan besar kecilnya, bermanfaat nanti jika bot dimasukkan grup.
...
function create_response($text, $message)
{
    ...
    switch ($command[0]) {
        ...
        case '/case':
        case '/case' . $usernamebot:
            $hasil  = "$namauser, ini case pertamamu :\n";
            $hasil .= "1.semoga aku bisa membuat bot\n2.masukkan ke database";
            break;
